"use server"
// we start every server action with use server 

import { db } from "@/db";
import { tickets } from "@/db/schema";
import { actionClient } from "@/lib/safe-action";
import { insertTicketSchema, insertTicketSchemaType } from "@/zod-schemas/ticket";
...
export const saveTicketAction = actionClient
  ...
  .action(async ({
    ...
    // const data = await fetch("https://jsnplacholder");
    // const query = sql.raw("SELECT * FROM Rht")
